...
// GetExeRootDir GetRootDir 获取执行路径
...
func AddToTableNameComment(s, c string, suff string) string {
	return "// " + s + " " + c + suff
}

// InArrayString 判断是否包存在某字符
